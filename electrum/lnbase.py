...
class Peer(PrintError):
    ...
    def on_update_fail_htlc(self, payload):
        ...
        asyncio.ensure_future(self.advance_local_and_remote_states(chan, htlc_id))

    @aiosafe
    async def advance_local_and_remote_states(self, chan, htlc_id):
        # after failing an htlc
    ...
    def on_update_fulfill_htlc(self, update_fulfill_htlc_msg):
        ...
        asyncio.ensure_future(self.finish_removing_htlc(chan, htlc))

    @aiosafe
    async def finish_removing_htlc(self, chan, htlc):
